...
$.extend(prototype, {
    ...
    button: function (args) {
        ...
        if (typeof args === 'string') {
            ...
            $.each(args, function (i, val) {
                ...
                + (val.autofocus ? ' autofocus class="ui-button ui-button-green"' : 'class="ui-button"')
                + '>'
                +   val.value
                + '</a> ';
    ...
    _trigger: function (id) {
        ...
        return typeof fn !== 'function' || fn.call(this,id) !== false ?
            (this.closeStrategy === 'hidden' ? this.close() : this.close().remove()) : this;
    }
